...
DEMOS = [
    ...
    {"slug": "salon-en", "glyph": "E", "grad": "linear-gradient(150deg,#6E3B4F,#8A5468)",
     "en": ("Ember & Oak Salon", "Hair salon · Portland, OR", "Boutique salon — consult-first positioning"),
     "kr": ("Ember & Oak Salon", "헤어살롱 · 포틀랜드(미국형)", "미국 시장용 영어 데모 — 살롱")},
    {"slug": "cafe-en", "glyph": "D", "grad": "linear-gradient(150deg,#4E342A,#6B4A3B)",
     "en": ("Driftwood Coffee", "Coffee shop · Austin, TX", "Neighborhood cafe — subscriptions & events"),
     "kr": ("Driftwood Coffee", "카페 · 오스틴(미국형)", "미국 시장용 영어 데모 — 카페")},
    ...
    {"slug": "salon-ja", "glyph": "結", "grad": "linear-gradient(150deg,#6E3B4F,#8A5468)",
     "en": ("hair atelier Yui", "Hair salon · Kichijoji, Tokyo", "Japanese-market sample — 2-seat private salon"),
     "ja": ("hair atelier 結", "ヘアサロン · 吉祥寺", "2席のプライベートサロン — 担当制"),
     "kr": ("헤어 아틀리에 유이", "헤어살롱 · 도쿄(일본형)", "일본 시장용 일본어 데모 — 살롱")},
    {"slug": "cafe-ja", "glyph": "灯", "grad": "linear-gradient(150deg,#4E342A,#6B4A3B)",
     "en": ("Kissa Komorebi", "Kissaten · Shimokitazawa, Tokyo", "Japanese-market sample — roastery cafe"),
     "ja": ("喫茶こもれび", "喫茶店 · 下北沢", "自家焙煎とモーニング — 定期便で常連づくり"),
     "kr": ("킷사 코모레비", "카페 · 도쿄(일본형)", "일본 시장용 일본어 데모 — 킷사텐")},
    ...
    {"slug": "cafe-matcha", "glyph": "抹", "grad": "linear-gradient(150deg,#6B8E5A,#3E5636)",
     "en": ("Miru Matcha", "Matcha bar · Seoul", "Korean-market sample — matcha & latte bar"),
     "kr": ("미루 말차", "말차 바 · 성수", "당일 제분 말차 — 메뉴 그리드·정기권")},
